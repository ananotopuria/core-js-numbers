...
function getAverage(value1, value2) {
  ...
  const minFinite = -Number.MAX_VALUE;
  if (
    (value1 > 0 && value2 > maxFinite - value1) ||
    (value1 < 0 && value2 < minFinite - value1)
  ) {
    return value1 > 0 ? maxFinite : minFinite;
  }

  if (
    (value2 > 0 && value1 > maxFinite - value2) ||
    (value2 < 0 && value1 < minFinite - value2)
  ) {
    return value2 > 0 ? maxFinite : minFinite;
  }
